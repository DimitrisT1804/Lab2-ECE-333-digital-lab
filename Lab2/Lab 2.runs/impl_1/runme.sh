...
HD_PWD='C:/Users/jimar/Desktop/digital_lab/lab2/Lab2/Lab 2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART2.tcl -notrace
